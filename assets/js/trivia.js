...
$("#start-btn").on("click", function () {
    ...
    for (var i = 0; i < triviaQuestions.length; i++) {
        ...
        for (var k = 0; k < triviaQuestions[i].answers.length; k++) {
            $("#question-disp").append("<button class='mx-1 btn btn-secondary'> <input type='radio' checked autocomplete='off' data-toggle='button' aria-pressed='false' auto name='" + i + "' value='" + triviaQuestions[i].answers[k] + "'>" + triviaQuestions[i].answers[k]+"</button>")
        }
    }
})
